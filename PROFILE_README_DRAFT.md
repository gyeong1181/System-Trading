...
## What I Build
- Webhook 기반 서비스 실행기
- EC2 + systemd 기반 상시 구동 환경
- GitHub Actions 기반 자동 배포
- Prometheus / Grafana / Telegram 기반 모니터링
...
## Note
이 파일은 GitHub 프로필 README 초안입니다.  
실제로 GitHub 프로필 메인에 표시하려면, 사용자명과 동일한 이름의 별도 저장소(`gyeong1181/gyeong1181`)의 `README.md`로 옮겨야 합니다.
