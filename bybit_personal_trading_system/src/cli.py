...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--root",
        default=None,
        help="레포 루트 경로입니다. 기본값은 현재 설치된 프로젝트 위치입니다.",
    )
    ...
    subparsers.add_parser("research-all", help="백테스트, 워크포워드, 자동 랭킹을 한 번에 수행합니다.")
    ...
    subparsers.add_parser("live-start", help="Bybit 소액 실거래 엔진을 시작합니다.")
    ...
    subparsers.add_parser("kill", help="킬 스위치를 켜고 실행 중 엔진이 정리 종료되도록 지시합니다.")
    return parser
