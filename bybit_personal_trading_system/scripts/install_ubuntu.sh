...
sudo apt-get install -y docker.io docker-compose-v2 make python3 python3-pip python3-venv curl
...
echo "설치가 끝났습니다. 새 셸을 열고 다음 순서로 진행하세요."
echo "1. cp .env.example .env"
echo "2. .env 값 입력"
echo "3. make bootstrap"
echo "4. make research-all"
echo "5. make demo-start"
